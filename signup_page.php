<script>
      ...
      // Récupérer l'image de couverture du livre de la base de données
      window.onload = function() {
        var output = document.getElementById('imagePreview');
        // Remplacer '../assets/img/background.jpg' par l'URL de l'image de couverture du livre dans la base de données
        output.style.backgroundImage = "url('URL_DE_L'IMAGE_EN_BASE')";
        output.style.backgroundSize = "cover";
        output.style.height = "150px";
        output.style.width = "150px";
      }
